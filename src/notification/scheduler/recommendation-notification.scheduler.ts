...
export class RecommendationNotificationScheduler{
    private readonly logger = new Logger(RecommendationNotificationScheduler.name);
    ...
    async sendWeeklyRecommendNotifications(){
        this.logger.log('Running weekly recommend concert notifications (Mon 10:00 KST)');
        ...
        const title = '추천 콘서트';
        const content = '선택하신 취향을 바탕으로 지금 가장 잘 맞는 콘서트 하나를 골라봤어요!';
